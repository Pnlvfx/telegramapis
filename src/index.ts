...
import { sendMedia } from './helpers/media';
import { CommandResponse, DownloadRes, TelegramError, TelegramResponse, WebhookResponse } from './types/response';
import { Message } from './types/webhook';
import path from 'node:path';

const telegramError = (err: TelegramError) => {
